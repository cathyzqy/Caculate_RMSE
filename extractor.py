...
def export_data(sender, receiver, sender_instance, receiver_instance, start_time, end_time, monitor_url, cluster,
                **params):
    if cluster == 'prp':
        AVG_INT = 1
        query = (
...
def main(transfer_id, cluster):
    ...
    ts_data = export_data(sender, receiver, sender_instance, receiver_instance, result['start_time'],
